...
import com.org.opencart.qa.utilies.StringUtilies;
	...
	// 3. Private By Locators
	   private final By firstName = By.id("input-firstname");
		...
		public boolean userRegisteration(String firstName, String lastName,
			...
			eleUtil.doSendKeys(this.email, StringUtilies.getRandomEmailId());
			...
			if (eleUtil.waitForElementVisible(successMessg, AppConstants.SHORT_TIME_OUT).getText().contains(AppConstants.REGISTER_SUCCESS_MESSG)) {
